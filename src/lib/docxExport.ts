...
const boldText = (text: string, color = COLORS.NAVY) =>
  new TextRun({
    text,
    bold: true,
    font: FONT,
...
export async function exportTalentReportToDocx(
  ...
  children.push(
    createTable(
      ...
      [
        [
          "Entry",
          report?.salary?.india?.entry || "-",
          report?.salary?.international?.entry || "-",
        ],
        [
          "Mid",
          report?.salary?.india?.mid || "-",
          report?.salary?.international?.mid || "-",
        ],
        [
          "Senior",
          report?.salary?.india?.senior || "-",
          report?.salary?.international?.senior || "-",
        ],
      ],
      [2500, 3430, 3430]
    )
  ...
  children.push(
    paragraph("Best Interview Approach", {
      bold: true,
      color: COLORS.NAVY,
      spacingBefore: 100,
    })
