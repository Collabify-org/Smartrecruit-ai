      ...
      <div className="max-w-6xl mx-auto px-6 py-20 sm:py-24">
        ...
        <div className="mt-14 space-y-20 sm:space-y-28">
          ...
          <DemoRow
            ...
            desc="Type the role and seniority. Synlumex Smart Format mode produces a polished, best-practice job description in under a minute — fully editable."
            bullets={[
          ...
          <DemoRow
            ...
            desc="Paste any job description and Synlumex instantly generates a complete phone screening question sheet — candidate details, role-specific questions, CTC, notice period, and feedback fields. Ready to use on your next call."
            bullets={[
...
function DemoCustomTemplate() {
  ...
  return (
    <DemoFrame title="app.synlumex.ai/jd-generator · Custom Template">
...
function DemoSmartFormat() {
  ...
  return (
    <DemoFrame title="app.synlumex.ai/jd-generator · Smart Format">
      <div className="bg-gradient-subtle p-5 min-h-[360px] space-y-3">
...
function DemoTalentIntelligence() {
  ...
  return (
    <DemoFrame title="app.synlumex.com/talent-intelligence">
      <div className="bg-gradient-subtle p-5 min-h-[360px] space-y-3">
        {/* Pasted JD */}
        <div className="rounded-lg border border-border bg-background p-3">
...
function DemoInterviewQuestions() {
  ...
  return (
    <DemoFrame title="app.synlumex.com/interview-questions · Phone Screen Sheet">
      <div className="bg-gradient-subtle p-5 min-h-[360px] space-y-3">
